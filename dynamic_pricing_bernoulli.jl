...
final_avg_reward_ucb, final_avg_regret_ucb, count_ucb = evaluate(arms, horizon, "UCB", ν)
...
final_avg_reward_etc, final_avg_regret_etc, count_etc = evaluate(arms, horizon, "ETC", ν)
...
final_avg_reward_eps, final_avg_regret_eps, count_eps = evaluate(arms, horizon, "epsgreedy", ν)
