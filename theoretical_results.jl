...
# ╔═╡ 1c0a4570-a8ce-472d-8740-7c7e87b32660
using Distributions, StatsBase, Plots, Interact, PlutoUI

# ╔═╡ fab2472e-f7e4-11ef-2805-bbb3e93ebf2a
include("algoritmos.jl")

# ╔═╡ 13b54161-2dc3-4dcb-8933-bf06844ee289
md""" # Definições"""

# ╔═╡ 1d04ccc6-c7ed-48e2-8a60-c5cd4c32a6e3
begin
	n_simulations = 1000
	horizon = 10000 
	n_arms = 20
	arms = [Bernoulli(0.1), Bernoulli(0.2), Bernoulli(0.3), Bernoulli(0.5) ]
end

# ╔═╡ dc46a241-7f53-40c6-9650-aca9c2808b4b
arms[end]

# ╔═╡ 990fbf11-6a19-41d5-8172-181760fb5de6
selected_arms_halving, avg_reward_vector_halving, c_arms_halving = simulate_pure_exp(arms, horizon, "seq_halving", nothing, 1000, false)

# ╔═╡ 99219974-f794-4cfb-b24c-649bc1e8cafa
c_arms_halving

# ╔═╡ b288773b-6b3c-408c-8ba7-3eba29d3c576
function freq_error(arms, horizon, strategy, distr,  n_simulations, dynamic_pricing)
	_,_,c = simulate_pure_exp(arms, horizon, strategy, distr,  n_simulations, dynamic_pricing)
	c = Dict(k.p => v for (k,v) ∈ c)
	println(c)
	return c[0.5]
end 

# ╔═╡ 60c93285-8f1c-4e42-bf70-836d8bfe35da
length(arms)

# ╔═╡ 20a5eec0-9e9f-458e-83e0-c78d79cce443
begin
	plot(n -> 1-freq_error(arms, n, "seq_halving", nothing, 1000, false), 100:100:10000, dpi=1000, label="metades")
	plot!(n -> 1-freq_error(arms, n, "seq_elim", nothing, 1000, false), 100:100:10000, label="sequencial")
	xlabel!("horizonte")
...
manifest_format = "2.0"
project_hash = "e3cdca03c6a3eefe93bbe1ffe37829fe2fbb357a"
